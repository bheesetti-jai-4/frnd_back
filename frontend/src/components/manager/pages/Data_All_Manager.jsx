...
import { managerAllforms } from "../../../server/Manager_Axios";
// import { TiTick ,TiTimes} from "react-icons/ti";



const Data_All_Manager = () => {
...
// const Deta_All = () => {
    ...
    useEffect(() => {
      const fetchData = async () => {
        try {
        //   const response = await userFormHistory(); // Fetch all form history   managerAllforms
...
export default Data_All_Manager;
