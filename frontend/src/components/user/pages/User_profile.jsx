          ...
          <div className="md:w-2/3 md:pl-8">
            ...
            <p className="text-gray-700  mb-2">Id :  {user ? user._id : "id"} </p>
              ...
              <div className="flex flex-wrap gap-2 mt-5 mb-6">
                <Link to="/userdashbord/updateuser" className="bg-blue-600 text-white px-5 mx-10 py-3 cursor-pointer rounded-xl text-sm hover:bg-blue-900 hover:text-white transition-colors duration-300"  >
                {/* <Link to="/register" > eddit Profile</Link> */}
